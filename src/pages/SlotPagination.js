...
const Pagination = ({pages, setCurrentPage, currentSlots, sortedSlots}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentSlots.length}</b> out of <b>{sortedSlots.length}</b> entries</div>
